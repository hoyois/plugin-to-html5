if(window.safari) {
	...
	if(window.MediaSource) script += "document.createElement(\"video\").constructor.prototype.canPlayType=function(){return\"\";};window.MediaSource.isTypeSupported=function(){return false;};";
